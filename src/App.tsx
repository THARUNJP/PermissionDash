  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      ...
      <header className="w-full max-w-5xl mb-6 text-center">
        <h1 className="text-3xl font-bold text-red-800">Permission Dashboard</h1>
      ...
      {STATUS.map((perm) => (
          ...
          >
            <div>
              <h2 className="text-xl font-semibold text-gray-800">{perm.name}</h2>
              <p className="mt-2 text-gray-600">{perm.status}</p>
            </div>
